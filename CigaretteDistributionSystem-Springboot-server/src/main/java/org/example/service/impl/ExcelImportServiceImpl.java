...
import org.example.service.importer.BaseCustomerTableManager;
import org.example.service.importer.ExcelParseHelper;
import org.example.service.importer.ImportValidationHelper;
import org.example.service.importer.IntegrityGroupMappingService;
import org.example.service.importer.CigaretteInfoWriter;
...
public class ExcelImportServiceImpl implements ExcelImportService {
    ...
    private static final String BASE_CUSTOMER_TABLE = "base_customer_info";
    private static final String MANDATORY_CUSTOMER_COLUMN = "CUST_CODE";
    ...
    private Map<String, Object> importCigaretteDistributionInfo(org.example.dto.CigaretteImportRequestDto request) {
     ...
     */
    @Transactional(rollbackFor = Exception.class, timeout = 120)
    private Map<String, Object> importBaseCustomerInfo(org.example.dto.BaseCustomerInfoImportRequestDto request) {
        Map<String, Object> result = new HashMap<>();
        ...
        try {
            ...
            result.put("tableName", BASE_CUSTOMER_TABLE);
    ...
    public Map<String, Object> importData(DataImportRequestDto request) {
        ...
        try {
            ...
            org.example.dto.BaseCustomerInfoImportRequestDto baseCustomerRequest = new org.example.dto.BaseCustomerInfoImportRequestDto();
            ...
            org.example.dto.CigaretteImportRequestDto cigaretteRequest = new org.example.dto.CigaretteImportRequestDto();
