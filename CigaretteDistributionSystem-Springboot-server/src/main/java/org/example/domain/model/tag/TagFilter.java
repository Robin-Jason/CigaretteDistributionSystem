...
public class TagFilter {
    ...
    public TagFilter(String tagName, String column, String operator, String rawValue, ValueType valueType) {
     ...
     * @example
     * <pre>
     *     TagFilter rule = new TagFilter("tag1", "COLUMN1", "=", "100", ValueType.NUMBER);
     *     Object sqlValue = rule.toSqlValue();
     *     // 返回: BigDecimal(100)
     *     TagFilter rule2 = new TagFilter("tag2", "COLUMN2", "=", "true", ValueType.BOOLEAN);
