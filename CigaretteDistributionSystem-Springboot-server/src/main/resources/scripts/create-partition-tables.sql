...
CREATE TABLE IF NOT EXISTS cigarette_distribution_info (
    ...
    DELIVERY_AREA VARCHAR(800) COMMENT '投放区域（最大长度800字符，支持双扩展类型的笛卡尔积区域组合）',
    BZ VARCHAR(255) COMMENT '备注',
    HIGHEST_GRADE VARCHAR(255) DEFAULT 'D30' COMMENT '最高档位',
    LOWEST_GRADE VARCHAR(255) DEFAULT 'D1' COMMENT '最低档位',
    TAG_FILTER_CONFIG VARCHAR(1000) COMMENT '标签过滤配置',
    CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    UPDATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (ID, YEAR, MONTH, WEEK_SEQ),
...
CREATE TABLE IF NOT EXISTS cigarette_distribution_prediction (
    ...
    CIG_CODE VARCHAR(255) NOT NULL COMMENT '卷烟代码',
    CIG_NAME VARCHAR(255) NOT NULL COMMENT '卷烟名称',
    DELIVERY_AREA VARCHAR(50) COMMENT '投放区域',
    DELIVERY_METHOD VARCHAR(255) COMMENT '投放方法',
    DELIVERY_ETYPE VARCHAR(255) COMMENT '扩展投放类型',
    TAG VARCHAR(100) COMMENT '标签',
    TAG_FILTER_CONFIG VARCHAR(500) COMMENT '标签过滤配置',
...
CREATE TABLE IF NOT EXISTS base_cigarette_price (
    ...
    BARCODE VARCHAR(64) DEFAULT NULL COMMENT '卷烟编码/条码',
    CIG_NAME VARCHAR(255) NOT NULL COMMENT '卷烟名称',
    BRAND_NAME VARCHAR(255) DEFAULT NULL COMMENT '品牌名称',
    MANUFACTURER_NAME VARCHAR(255) DEFAULT NULL COMMENT '工业企业名称',
    WHOLESALE_PRICE DECIMAL(18,2) DEFAULT NULL COMMENT '批发价',
    CATEGORY VARCHAR(64) DEFAULT NULL COMMENT '价类',
    PRICE_TIER VARCHAR(64) DEFAULT NULL COMMENT '价档',
    PRICE_HL TINYINT(1) DEFAULT 0 COMMENT '高/低价位(1高0低)',
    CREATED_AT TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    UPDATED_AT TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (ID),
    UNIQUE KEY UK_CIG_CODE (CIG_CODE),
    KEY IDX_CIG_NAME (CIG_NAME)
...
CREATE TABLE IF NOT EXISTS cigarette_distribution_prediction_price (
    ...
    TAG_FILTER_CONFIG VARCHAR(255) COMMENT '标签过滤配置',
    D30 DECIMAL(18,2) COMMENT 'D30档位分配值',
    D29 DECIMAL(18,2) COMMENT 'D29档位分配值',
    D28 DECIMAL(18,2) COMMENT 'D28档位分配值',
    D27 DECIMAL(18,2) COMMENT 'D27档位分配值',
