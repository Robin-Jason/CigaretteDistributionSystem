 ...
 */
@Mapper
public interface CigaretteDistributionPredictionMapper extends BaseMapper<CigaretteDistributionPredictionData> {
     ...
     * @return 影响行数
     */
    int upsert(CigaretteDistributionPredictionData data);
     ...
     * @return 影响行数
     */
    int batchUpsert(@Param("list") List<CigaretteDistributionPredictionData> list);
     ...
     * @return 影响行数
     */
    int updateOne(CigaretteDistributionPredictionData data);
