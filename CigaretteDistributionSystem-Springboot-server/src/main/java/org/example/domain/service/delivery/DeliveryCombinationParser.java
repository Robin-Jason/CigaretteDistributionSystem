package org.example.domain.service.delivery;
...
public class DeliveryCombinationParser {
     ...
     * @return 规范化投放组合
     */
    public DeliveryCombination parse(CigaretteDistributionInfoPO infoData) {
        if (infoData == null) {
            throw new IllegalArgumentException("CigaretteDistributionInfoPO不能为空");
        }
