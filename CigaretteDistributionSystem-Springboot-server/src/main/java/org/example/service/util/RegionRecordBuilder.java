...
import static org.example.service.util.GradeParser.parseGradeToIndex;
import static org.example.service.util.MapValueExtractor.getLongValue;
import static org.example.service.util.MapValueExtractor.getStringValue;
import static org.example.service.util.RegionNameBuilder.buildRegionName;
...
public class RegionRecordBuilder {
    ...
    public List<RegionCustomerRecord> buildRecordsForExtensions(
        ...
        List<Map<String, Object>> combinations = temporaryCustomerTableMapper.listDistinctCombinations(temporaryTableName, selectColumns);
    ...
    public RegionCustomerRecord buildRecordForRegion(
        ...
        List<Map<String, Object>> gradeStats = temporaryCustomerTableMapper.statGrades(
